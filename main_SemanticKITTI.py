...
class SemanticKITTI:
    def __init__(self, test_id):
        ...
        self.original_dataset_path = '/home/chx/Work/semantic-kitti/sequences'
    ...
    def get_tf_mapping2():
        ...
        def tf_map(batch_pc, batch_label, batch_pc_idx, batch_cloud_idx):
            input_list = [batch_pc, batch_label, batch_pc_idx, batch_cloud_idx]
            return input_list
        return tf_map
    ...
    def init_input_pipeline(self):
        ...
        self.batch_test_data = self.batch_test_data.map(map_func=map_func, num_parallel_calls=tf.data.experimental.AUTOTUNE)
